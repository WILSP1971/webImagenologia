...
"Invoke-RestMethod -Method Post http://localhost:8042/modalities/pacs/echo")
    ...
    callout("Validado (2026-08-07)", "<font face='Courier' size=9>https://appsintranet.esculapiosis.com/PortalImagenologia/stone-webviewer/index.html</font> carga el splash y el WASM de Stone por HTTPS. La app .NET abre estudios con <font face='Courier' size=9>.../stone-webviewer/index.html?study={StudyInstanceUID}</font> (motor='stone' en Abrir.cshtml). Prueba end-to-end sin PACS: subir un .dcm por Orthanc Explorer (Upload) y abrir su StudyInstanceUID en Stone.")
